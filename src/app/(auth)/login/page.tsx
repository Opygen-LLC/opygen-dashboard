    ...
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8 overflow-hidden text-foreground transition-colors duration-200">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
            OpyDash
          </h2>
        ...
        <Card className="border-border bg-card/60 backdrop-blur-md text-card-foreground shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-muted-foreground">
              Enter your co-founder credentials to access OpyDash
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <div className="text-center text-xs text-muted-foreground">
                Default password: <span className="font-mono text-foreground font-semibold">password123</span>
              </div>
            </CardFooter>
          </form>
        </Card>
