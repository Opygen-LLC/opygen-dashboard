...
export default function DashboardPage() {
    ...
    const cards = [
        ...
        },
        {
            ...
            icon: Clock,
            color: "from-sky-500/5 to-indigo-500/5 dark:from-sky-500/10 dark:to-indigo-500/20 text-sky-650 dark:text-sky-405 border-sky-500/20 dark:border-sky-500/30",
        },
        {
            title: "Completed",
            ...
            icon: CheckCircle2,
            color: "from-emerald-500/5 to-teal-500/5 dark:from-emerald-500/10 dark:to-teal-500/20 text-emerald-655 dark:text-emerald-400 border-emerald-500/20 dark:border-emerald-500/30",
        },
        {
            title: "Overdue",
            ...
            <div className="flex justify-between items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Satisfying stats and workload summary at a glance.
                    </p>
                </div>
                <Button
                    variant="outline"
                ...
                >
                    <RefreshCw
                        className={`h-4.5 w-4.5 ${isRefetching ? "animate-spin text-indigo-550" : ""}`}
                    />
                </Button>
            </div>
                ...
                {cards.map((card) => {
                    ...
                    return (
                        <motion.div key={card.title} variants={itemVariants}>
                            <Card
                                className={`bg-gradient-to-br ${card.color} border bg-card text-card-foreground shadow-md backdrop-blur-xs relative overflow-hidden group`}
                            >
